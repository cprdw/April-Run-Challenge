...
//
//                                
//                                                                ProgressRing(color1: #colorLiteral(red: 0.4392156899, green: 0.01176470611, blue: 0.1921568662, alpha: 1), color2: #colorLiteral(red: 0.1215686277, green: 0.01176470611, blue: 0.4235294163, alpha: 1), width: 200, height: 200, percent: CGFloat(100 * (self.pushupsDone + self.runningDone + self.sitUpsDone) / 20100 ), colorPercent: true)
//
//                            }
...
//                            Spacer()
//                            Spacer()
//                            CardView1(value: self.$pushupsDone, top: 10000)
//                                .padding(.top)
